...
class Deux_Widgets_PopularPosts extends WP_Widget {
	/**
	...
	function __construct() {
		...
		parent::__construct(
			...
			esc_html__( 'Deux - PopularPost', 'deux' ),
			array(
				'classname'   => 'popular-posts-widget',
				'description' => esc_html__( 'Display most popular posts', 'deux' ),
			...
			<div class="popular-post post clearfix <?php echo esc_attr( $class ); ?>">
				...
				if ( ! $class ) {
					printf(
						...
						get_the_post_thumbnail( get_the_ID(), 'deux-widget-thumbnail' )
					);
				}
				?>
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'limit' ) ); ?>"><?php esc_html_e( 'Number Of Posts', 'deux' ); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'show_date' ) ); ?>"><?php esc_html_e( 'Show Date', 'deux' ); ?></label>
		</p>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'show_thumb' ) ); ?>"><?php esc_html_e( 'Show Thumbnail', 'deux' ); ?></label>
		</p>
