...
/**
 * Class Deux_Nav_MegaMenuWalker
 *
 * Walker class for mega menu
 */
class Deux_Nav_MegaMenuWalker extends Walker_Nav_Menu {
	/**
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		$item_mega = deux_parse_args( $item_mega, deux_get_mega_menu_setting_default() );
		...
		// Adds icon
		if ( $item_mega['icon'] ) {
			$icon = deux_get_font_icon_html( $item_mega['icon'] );
		} else {
			$icon = '';
		}
